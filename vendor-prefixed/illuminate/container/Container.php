...
use MyVendorPrefix\Illuminate\Contracts\Container\CircularDependencyException;
use MyVendorPrefix\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
