...
namespace MyVendorPrefix\Illuminate\Support\Traits;
...
use MyVendorPrefix\Illuminate\Support\HigherOrderCollectionProxy;
use InvalidArgumentException;
use JsonSerializable;
use MyVendorPrefix\Symfony\Component\VarDumper\VarDumper;
use Traversable;
...
trait EnumeratesValues
{
    ...
    public function ensure($type)
    {
        ...
        return $this->each(function ($item) use ($allowedTypes) {
            ...
            throw new UnexpectedValueException(sprintf("Collection should only include [%s] items, but '%s' found.", implode(', ', $allowedTypes), $itemType));
        });
    }
    /**
