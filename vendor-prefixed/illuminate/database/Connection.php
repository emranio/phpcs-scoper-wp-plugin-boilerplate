...
use MyVendorPrefix\Doctrine\DBAL\Connection as DoctrineConnection;
use MyVendorPrefix\Doctrine\DBAL\Types\Type;
use Exception;
use MyVendorPrefix\Illuminate\Contracts\Events\Dispatcher;
use MyVendorPrefix\Illuminate\Database\Events\QueryExecuted;
use MyVendorPrefix\Illuminate\Database\Events\StatementPrepared;
use MyVendorPrefix\Illuminate\Database\Events\TransactionBeginning;
use MyVendorPrefix\Illuminate\Database\Events\TransactionCommitted;
use MyVendorPrefix\Illuminate\Database\Events\TransactionCommitting;
use MyVendorPrefix\Illuminate\Database\Events\TransactionRolledBack;
use MyVendorPrefix\Illuminate\Database\Query\Builder as QueryBuilder;
use MyVendorPrefix\Illuminate\Database\Query\Expression;
use MyVendorPrefix\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use MyVendorPrefix\Illuminate\Database\Query\Processors\Processor;
use MyVendorPrefix\Illuminate\Database\Schema\Builder as SchemaBuilder;
use MyVendorPrefix\Illuminate\Support\Arr;
use MyVendorPrefix\Illuminate\Support\InteractsWithTime;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return class_exists('MyVendorPrefix\Doctrine\DBAL\Connection');
    }
    /**
