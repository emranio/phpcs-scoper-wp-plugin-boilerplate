...
namespace MyVendorPrefix\Illuminate\Database\Migrations;

use MyVendorPrefix\Doctrine\DBAL\Schema\SchemaException;
use MyVendorPrefix\Illuminate\Console\View\Components\BulletList;
use MyVendorPrefix\Illuminate\Console\View\Components\Error;
use MyVendorPrefix\Illuminate\Console\View\Components\Info;
use MyVendorPrefix\Illuminate\Console\View\Components\Task;
use MyVendorPrefix\Illuminate\Console\View\Components\TwoColumnDetail;
...
use MyVendorPrefix\Illuminate\Database\Events\MigrationEnded;
use MyVendorPrefix\Illuminate\Database\Events\MigrationsEnded;
use MyVendorPrefix\Illuminate\Database\Events\MigrationsStarted;
use MyVendorPrefix\Illuminate\Database\Events\MigrationStarted;
use MyVendorPrefix\Illuminate\Database\Events\NoPendingMigrations;
use MyVendorPrefix\Illuminate\Filesystem\Filesystem;
