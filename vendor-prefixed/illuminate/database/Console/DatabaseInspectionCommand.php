...
use MyVendorPrefix\Illuminate\Console\Command;
use MyVendorPrefix\Illuminate\Database\ConnectionInterface;
use MyVendorPrefix\Illuminate\Database\MySqlConnection;
use MyVendorPrefix\Illuminate\Database\PostgresConnection;
use MyVendorPrefix\Illuminate\Database\QueryException;
use MyVendorPrefix\Illuminate\Database\SQLiteConnection;
use MyVendorPrefix\Illuminate\Database\SqlServerConnection;
use MyVendorPrefix\Illuminate\Support\Arr;
use MyVendorPrefix\Illuminate\Support\Composer;
use MyVendorPrefix\Symfony\Component\Process\Exception\ProcessSignaledException;
use MyVendorPrefix\Symfony\Component\Process\Exception\RuntimeException;
use MyVendorPrefix\Symfony\Component\Process\Process;
use function MyVendorPrefix\Laravel\Prompts\confirm;
abstract class DatabaseInspectionCommand extends Command
{
    ...
    {
        return tap(interface_exists('MyVendorPrefix\Doctrine\DBAL\Driver'), function ($dependenciesExist) {
    ...
    {
        $command = collect($this->composer->findComposer())->push('require doctrine/dbal:^3.5.1')->implode(' ');
