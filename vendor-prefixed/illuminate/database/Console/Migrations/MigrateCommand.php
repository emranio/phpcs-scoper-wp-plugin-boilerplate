...
namespace MyVendorPrefix\Illuminate\Database\Console\Migrations;

use MyVendorPrefix\Illuminate\Console\ConfirmableTrait;
use MyVendorPrefix\Illuminate\Contracts\Console\Isolatable;
use MyVendorPrefix\Illuminate\Contracts\Events\Dispatcher;
use MyVendorPrefix\Illuminate\Database\Events\SchemaLoaded;
use MyVendorPrefix\Illuminate\Database\Migrations\Migrator;
use MyVendorPrefix\Illuminate\Database\SQLiteDatabaseDoesNotExistException;
