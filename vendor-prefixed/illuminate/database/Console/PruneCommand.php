...
use MyVendorPrefix\Illuminate\Database\Eloquent\MassPrunable;
use MyVendorPrefix\Illuminate\Database\Eloquent\Prunable;
use MyVendorPrefix\Illuminate\Database\Eloquent\SoftDeletes;
use MyVendorPrefix\Illuminate\Database\Events\ModelPruningFinished;
use MyVendorPrefix\Illuminate\Database\Events\ModelPruningStarting;
use MyVendorPrefix\Illuminate\Database\Events\ModelsPruned;
use MyVendorPrefix\Illuminate\Support\Str;
use InvalidArgumentException;
use MyVendorPrefix\Symfony\Component\Finder\Finder;
class PruneCommand extends Command
{
    ...
    protected function models()
    {
        ...
        return collect(Finder::create()->in($this->getPath())->files()->name('*.php'))->map(function ($model) {
