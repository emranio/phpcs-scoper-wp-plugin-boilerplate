...
use MyVendorPrefix\Illuminate\Database\Events\ConnectionEstablished;
use MyVendorPrefix\Illuminate\Support\Arr;
use MyVendorPrefix\Illuminate\Support\ConfigurationUrlParser;
...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    {
        if (!class_exists('MyVendorPrefix\Doctrine\DBAL\Connection')) {
