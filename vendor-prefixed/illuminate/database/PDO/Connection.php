...
use MyVendorPrefix\Doctrine\DBAL\Driver\PDO\Exception;
use MyVendorPrefix\Doctrine\DBAL\Driver\PDO\Result;
use MyVendorPrefix\Doctrine\DBAL\Driver\PDO\Statement;
use MyVendorPrefix\Doctrine\DBAL\Driver\Result as ResultInterface;
use MyVendorPrefix\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use MyVendorPrefix\Doctrine\DBAL\Driver\Statement as StatementInterface;
use MyVendorPrefix\Doctrine\DBAL\ParameterType;
use PDO;
use PDOException;
use PDOStatement;
