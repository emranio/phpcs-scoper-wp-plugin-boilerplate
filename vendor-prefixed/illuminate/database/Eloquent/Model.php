...
use ArrayAccess;
use MyVendorPrefix\Illuminate\Contracts\Broadcasting\HasBroadcastChannel;
use MyVendorPrefix\Illuminate\Contracts\Queue\QueueableCollection;
use MyVendorPrefix\Illuminate\Contracts\Queue\QueueableEntity;
use MyVendorPrefix\Illuminate\Contracts\Routing\UrlRoutable;
use MyVendorPrefix\Illuminate\Contracts\Support\Arrayable;
use MyVendorPrefix\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use MyVendorPrefix\Illuminate\Contracts\Support\Jsonable;
use MyVendorPrefix\Illuminate\Database\ConnectionResolverInterface as Resolver;
use MyVendorPrefix\Illuminate\Database\Eloquent\Collection as EloquentCollection;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\Concerns\AsPivot;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\Pivot;
...
use MyVendorPrefix\Illuminate\Support\Traits\ForwardsCalls;
use JsonException;
...
{
    use Concerns\HasAttributes, Concerns\HasEvents, Concerns\HasGlobalScopes, Concerns\HasRelationships, Concerns\HasTimestamps, Concerns\HasUniqueIds, Concerns\HidesAttributes, Concerns\GuardsAttributes, ForwardsCalls;
    /**
    ...
    {
        $defaults = array_values(array_filter([$this->getKeyName(), $this->getCreatedAtColumn(), $this->getUpdatedAtColumn(), ...$this->uniqueIds()]));
