...
use MyVendorPrefix\Illuminate\Database\Eloquent\RelationNotFoundException;
...
trait QueriesRelationships
{
    ...
    public function withAggregate($relations, $column, $function = null)
    {
        ...
        foreach ($this->parseWithRelations($relations) as $name => $constraints) {
            ...
            $alias ??= Str::snake(preg_replace('/[^[:alnum:][:space:]_]/u', '', "{$name} {$function} {$this->getQuery()->getGrammar()->getValue($column)}"));
            if ($function === 'exists') {
