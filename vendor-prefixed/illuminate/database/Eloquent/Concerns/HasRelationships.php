...
use Closure;
use MyVendorPrefix\Illuminate\Database\ClassMorphViolationException;
...
use MyVendorPrefix\Illuminate\Database\Eloquent\PendingHasThroughRelationship;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\BelongsTo;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\HasMany;
...
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\MorphMany;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\MorphOne;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\MorphTo;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\MorphToMany;
