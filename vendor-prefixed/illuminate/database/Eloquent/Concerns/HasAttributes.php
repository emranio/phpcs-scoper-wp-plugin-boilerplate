...
namespace MyVendorPrefix\Illuminate\Database\Eloquent\Concerns;

use BackedEnum;
use MyVendorPrefix\Brick\Math\BigDecimal;
use MyVendorPrefix\Brick\Math\Exception\MathException as BrickMathException;
use MyVendorPrefix\Brick\Math\RoundingMode;
use MyVendorPrefix\Carbon\CarbonImmutable;
use MyVendorPrefix\Carbon\CarbonInterface;
use DateTimeImmutable;
use DateTimeInterface;
use MyVendorPrefix\Illuminate\Contracts\Database\Eloquent\Castable;
use MyVendorPrefix\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use MyVendorPrefix\Illuminate\Contracts\Support\Arrayable;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsCollection;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsEncryptedArrayObject;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsEncryptedCollection;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsEnumArrayObject;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\AsEnumCollection;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\Attribute;
use MyVendorPrefix\Illuminate\Database\Eloquent\Casts\Json;
use MyVendorPrefix\Illuminate\Database\Eloquent\InvalidCastException;
use MyVendorPrefix\Illuminate\Database\Eloquent\JsonEncodingException;
use MyVendorPrefix\Illuminate\Database\Eloquent\MissingAttributeException;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\Relation;
use MyVendorPrefix\Illuminate\Database\LazyLoadingViolationException;
use MyVendorPrefix\Illuminate\Support\Arr;
use MyVendorPrefix\Illuminate\Support\Carbon;
use MyVendorPrefix\Illuminate\Support\Collection as BaseCollection;
use MyVendorPrefix\Illuminate\Support\Exceptions\MathException;
use MyVendorPrefix\Illuminate\Support\Facades\Crypt;
use MyVendorPrefix\Illuminate\Support\Facades\Date;
use MyVendorPrefix\Illuminate\Support\Facades\Hash;
...
trait HasAttributes
{
    ...
    public static function cacheMutatedAttributes($classOrInstance)
    {
        ...
        static::$getAttributeMutatorCache[$class] = collect($attributeMutatorMethods = static::getAttributeMarkedMutatorMethods($classOrInstance))->mapWithKeys(function ($match) {
