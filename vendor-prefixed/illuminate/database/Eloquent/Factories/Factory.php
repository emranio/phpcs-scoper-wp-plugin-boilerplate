...
namespace MyVendorPrefix\Illuminate\Database\Eloquent\Factories;

use Closure;
use MyVendorPrefix\Faker\Generator;
use MyVendorPrefix\Illuminate\Container\Container;
use MyVendorPrefix\Illuminate\Contracts\Foundation\Application;
...
use MyVendorPrefix\Illuminate\Support\Enumerable;
...
abstract class Factory
{
    ...
    {
        return collect($definition)->map($evaluateRelations = function ($attribute) {
