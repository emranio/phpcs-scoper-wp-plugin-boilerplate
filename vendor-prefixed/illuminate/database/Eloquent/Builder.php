...
use Closure;
use Exception;
use MyVendorPrefix\Illuminate\Contracts\Database\Eloquent\Builder as BuilderContract;
use MyVendorPrefix\Illuminate\Contracts\Database\Query\Expression;
use MyVendorPrefix\Illuminate\Contracts\Support\Arrayable;
use MyVendorPrefix\Illuminate\Database\Concerns\BuildsQueries;
use MyVendorPrefix\Illuminate\Database\Eloquent\Concerns\QueriesRelationships;
...
use MyVendorPrefix\Illuminate\Database\Query\Builder as QueryBuilder;
use MyVendorPrefix\Illuminate\Database\RecordsNotFoundException;
use MyVendorPrefix\Illuminate\Database\UniqueConstraintViolationException;
use MyVendorPrefix\Illuminate\Pagination\Paginator;
...
class Builder implements BuilderContract
{
     ...
     * @var string[]
     */
    protected $passthru = ['aggregate', 'average', 'avg', 'count', 'dd', 'ddrawsql', 'doesntexist', 'doesntexistor', 'dump', 'dumprawsql', 'exists', 'existsor', 'explain', 'getbindings', 'getconnection', 'getgrammar', 'getrawbindings', 'implode', 'insert', 'insertgetid', 'insertorignore', 'insertusing', 'insertorignoreusing', 'max', 'min', 'raw', 'rawvalue', 'sum', 'tosql', 'torawsql'];
    /**
    ...
    protected function ensureOrderForCursorPagination($shouldReverse = \false)
    {
        ...
        return collect($orders)->filter(fn($order) => Arr::has($order, 'direction'))->values();
    }
    /**
