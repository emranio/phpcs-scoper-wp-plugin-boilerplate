...
namespace MyVendorPrefix\Illuminate\Database\Query;

use BackedEnum;
use MyVendorPrefix\Carbon\CarbonPeriod;
use Closure;
use DateTimeInterface;
use MyVendorPrefix\Illuminate\Contracts\Database\Query\Builder as BuilderContract;
use MyVendorPrefix\Illuminate\Contracts\Database\Query\ConditionExpression;
use MyVendorPrefix\Illuminate\Contracts\Database\Query\Expression as ExpressionContract;
use MyVendorPrefix\Illuminate\Contracts\Support\Arrayable;
use MyVendorPrefix\Illuminate\Database\Concerns\BuildsQueries;
use MyVendorPrefix\Illuminate\Database\Concerns\ExplainsQueries;
use MyVendorPrefix\Illuminate\Database\ConnectionInterface;
use MyVendorPrefix\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use MyVendorPrefix\Illuminate\Database\Eloquent\Relations\Relation;
use MyVendorPrefix\Illuminate\Database\Query\Grammars\Grammar;
...
use MyVendorPrefix\Illuminate\Support\LazyCollection;
use MyVendorPrefix\Illuminate\Support\Str;
use MyVendorPrefix\Illuminate\Support\Traits\ForwardsCalls;
use MyVendorPrefix\Illuminate\Support\Traits\Macroable;
