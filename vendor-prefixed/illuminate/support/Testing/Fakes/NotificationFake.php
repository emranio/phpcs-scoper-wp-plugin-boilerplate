...
use Closure;
use Exception;
use MyVendorPrefix\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use MyVendorPrefix\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use MyVendorPrefix\Illuminate\Contracts\Queue\ShouldQueue;
use MyVendorPrefix\Illuminate\Contracts\Translation\HasLocalePreference;
use MyVendorPrefix\Illuminate\Notifications\AnonymousNotifiable;
...
use MyVendorPrefix\Illuminate\Support\Traits\ReflectsClosures;
use MyVendorPrefix\PHPUnit\Framework\Assert as PHPUnit;
