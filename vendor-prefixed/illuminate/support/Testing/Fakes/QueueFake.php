...
use Closure;
use MyVendorPrefix\Illuminate\Contracts\Queue\Queue;
use MyVendorPrefix\Illuminate\Queue\CallQueuedClosure;
use MyVendorPrefix\Illuminate\Queue\QueueManager;
