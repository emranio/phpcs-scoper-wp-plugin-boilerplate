 ...
 */
namespace MyVendorPrefix\Cake\Database;

use MyVendorPrefix\Cake\Cache\Cache;
use MyVendorPrefix\Cake\Core\App;
use MyVendorPrefix\Cake\Core\Retry\CommandRetry;
use MyVendorPrefix\Cake\Database\Exception\MissingConnectionException;
use MyVendorPrefix\Cake\Database\Exception\MissingDriverException;
use MyVendorPrefix\Cake\Database\Exception\MissingExtensionException;
use MyVendorPrefix\Cake\Database\Exception\NestedTransactionRollbackException;
use MyVendorPrefix\Cake\Database\Log\LoggedQuery;
use MyVendorPrefix\Cake\Database\Log\LoggingStatement;
use MyVendorPrefix\Cake\Database\Log\QueryLogger;
use MyVendorPrefix\Cake\Database\Query\DeleteQuery;
use MyVendorPrefix\Cake\Database\Query\InsertQuery;
use MyVendorPrefix\Cake\Database\Query\SelectQuery;
use MyVendorPrefix\Cake\Database\Query\UpdateQuery;
use MyVendorPrefix\Cake\Database\Retry\ReconnectStrategy;
use MyVendorPrefix\Cake\Database\Schema\CachedCollection;
use MyVendorPrefix\Cake\Database\Schema\Collection as SchemaCollection;
use MyVendorPrefix\Cake\Database\Schema\CollectionInterface as SchemaCollectionInterface;
use MyVendorPrefix\Cake\Datasource\ConnectionInterface;
use MyVendorPrefix\Cake\Log\Engine\BaseLog;
use MyVendorPrefix\Cake\Log\Log;
use MyVendorPrefix\Psr\Log\LoggerInterface;
use MyVendorPrefix\Psr\SimpleCache\CacheInterface;
...
class Connection implements ConnectionInterface
{
    ...
    public function getCacher(): CacheInterface
    {
        ...
        if (!class_exists(Cache::class)) {
            throw new RuntimeException('To use caching you must either set a cacher using Connection::setCacher()' . ' or require the cakephp/cache package in your composer config.');
        }
    ...
    public function getLogger(): LoggerInterface
    {
        ...
        if (!class_exists(BaseLog::class)) {
            throw new RuntimeException('For logging you must either set a logger using Connection::setLogger()' . ' or require the cakephp/log package in your composer config.');
        }
