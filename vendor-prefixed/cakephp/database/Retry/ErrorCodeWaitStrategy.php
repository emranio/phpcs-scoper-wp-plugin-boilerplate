 ...
 */
namespace MyVendorPrefix\Cake\Database\Retry;

use MyVendorPrefix\Cake\Core\Retry\RetryStrategyInterface;
use Exception;
use PDOException;
/**
...
class ErrorCodeWaitStrategy implements RetryStrategyInterface
{
    ...
    {
        if ($exception instanceof PDOException && $exception->errorInfo && in_array($exception->errorInfo[1], $this->errorCodes)) {
