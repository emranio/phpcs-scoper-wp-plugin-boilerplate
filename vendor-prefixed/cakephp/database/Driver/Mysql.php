...
use MyVendorPrefix\Cake\Database\Schema\MysqlSchemaDialect;
use MyVendorPrefix\Cake\Database\Schema\SchemaDialect;
use MyVendorPrefix\Cake\Database\Statement\MysqlStatement;
...
class Mysql extends Driver
{
     ...
     */
    protected $_baseConfig = ['persistent' => \true, 'host' => 'localhost', 'username' => 'root', 'password' => '', 'database' => 'cake', 'port' => '3306', 'flags' => [], 'encoding' => 'utf8mb4', 'timezone' => null, 'init' => []];
    /**
     ...
     */
    protected $featureVersions = ['mysql' => ['json' => '5.7.0', 'cte' => '8.0.0', 'window' => '8.0.0'], 'mariadb' => ['json' => '10.2.7', 'cte' => '10.2.1', 'window' => '10.2.0']];
    /**
    ...
    public function connect(): bool
    {
        ...
        $config['flags'] += [PDO::ATTR_PERSISTENT => $config['persistent'], PDO::MYSQL_ATTR_USE_BUFFERED_QUERY => \true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION];
    ...
    {
        return in_array('mysql', PDO::getAvailableDrivers(), \true);
    }
    /**
    ...
    public function supports(string $feature): bool
    {
        switch ($feature) {
            ...
            case static::FEATURE_WINDOW:
                return version_compare($this->version(), $this->featureVersions[$this->serverType][$feature], '>=');
        }
