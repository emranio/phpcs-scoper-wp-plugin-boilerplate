...
use MyVendorPrefix\Cake\Database\Expression\StringExpression;
use MyVendorPrefix\Cake\Database\PostgresCompiler;
use MyVendorPrefix\Cake\Database\Query;
use MyVendorPrefix\Cake\Database\QueryCompiler;
use MyVendorPrefix\Cake\Database\Schema\PostgresSchemaDialect;
...
class Postgres extends Driver
{
     ...
     */
    protected $_baseConfig = ['persistent' => \true, 'host' => 'localhost', 'username' => 'root', 'password' => '', 'database' => 'cake', 'schema' => 'public', 'port' => 5432, 'encoding' => 'utf8', 'timezone' => null, 'flags' => [], 'init' => []];
    /**
