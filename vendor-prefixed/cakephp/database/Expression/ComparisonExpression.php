    ...
    protected function _stringExpression(ValueBinder $binder): array
    {
        ...
        if ($this->_isMultiple) {
            ...
            if ($value === '') {
                ...
                throw new DatabaseException("Impossible to generate condition with empty list of values for field ({$field})");
            }
        } else {
            $template .= '%s %s';
...
// phpcs:disable
class_alias('MyVendorPrefix\Cake\Database\Expression\ComparisonExpression', 'MyVendorPrefix\Cake\Database\Expression\Comparison');
// phpcs:enable
