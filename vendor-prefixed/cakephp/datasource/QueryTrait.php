 ...
 */
namespace MyVendorPrefix\Cake\Datasource;

use BadMethodCallException;
use MyVendorPrefix\Cake\Collection\CollectionInterface;
use MyVendorPrefix\Cake\Collection\Iterator\MapReduce;
use MyVendorPrefix\Cake\Datasource\Exception\RecordNotFoundException;
...
trait QueryTrait
{
    ...
    public function __call(string $method, array $arguments)
    {
        ...
        if (in_array($method, get_class_methods($resultSetClass), \true)) {
            deprecationWarning(sprintf('Calling `%s` methods, such as `%s()`, on queries is deprecated. ' . 'You must call `all()` first (for example, `all()->%s()`).', ResultSetInterface::class, $method, $method), 2);
            $results = $this->all();
    ...
    {
        deprecationWarning('4.3.0 - Calling each() on a Query is deprecated. ' . 'Instead call `$query->all()->each(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling filter() on a Query is deprecated. ' . 'Instead call `$query->all()->filter(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling reject() on a Query is deprecated. ' . 'Instead call `$query->all()->reject(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling every() on a Query is deprecated. ' . 'Instead call `$query->all()->every(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling some() on a Query is deprecated. ' . 'Instead call `$query->all()->some(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling contains() on a Query is deprecated. ' . 'Instead call `$query->all()->contains(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling map() on a Query is deprecated. ' . 'Instead call `$query->all()->map(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling reduce() on a Query is deprecated. ' . 'Instead call `$query->all()->reduce(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling extract() on a Query is deprecated. ' . 'Instead call `$query->all()->extract(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling max() on a Query is deprecated. ' . 'Instead call `$query->all()->max(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling min() on a Query is deprecated. ' . 'Instead call `$query->all()->min(...)` instead.');
    ...
    {
        deprecationwarning('4.3.0 - calling avg() on a query is deprecated. ' . 'instead call `$query->all()->avg(...)` instead.');
    ...
    {
        deprecationwarning('4.3.0 - calling median() on a query is deprecated. ' . 'instead call `$query->all()->median(...)` instead.');
    ...
    {
        deprecationwarning('4.3.0 - calling sortBy() on a query is deprecated. ' . 'instead call `$query->all()->sortBy(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling groupBy() on a Query is deprecated. ' . 'Instead call `$query->all()->groupBy(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling indexBy() on a Query is deprecated. ' . 'Instead call `$query->all()->indexBy(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling countBy() on a Query is deprecated. ' . 'Instead call `$query->all()->countBy(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling sumOf() on a Query is deprecated. ' . 'Instead call `$query->all()->sumOf(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling shuffle() on a Query is deprecated. ' . 'Instead call `$query->all()->shuffle(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling sample() on a Query is deprecated. ' . 'Instead call `$query->all()->sample(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling take() on a Query is deprecated. ' . 'Instead call `$query->all()->take(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling takeLast() on a Query is deprecated. ' . 'Instead call `$query->all()->takeLast(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling skip() on a Query is deprecated. ' . 'Instead call `$query->all()->skip(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling match() on a Query is deprecated. ' . 'Instead call `$query->all()->match(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling firstMatch() on a Query is deprecated. ' . 'Instead call `$query->all()->firstMatch(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling last() on a Query is deprecated. ' . 'Instead call `$query->all()->last(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling append() on a Query is deprecated. ' . 'Instead call `$query->all()->append(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling appendItem() on a Query is deprecated. ' . 'Instead call `$query->all()->appendItem(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling prepend() on a Query is deprecated. ' . 'Instead call `$query->all()->prepend(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling prependItem() on a Query is deprecated. ' . 'Instead call `$query->all()->prependItem(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling combine() on a Query is deprecated. ' . 'Instead call `$query->all()->combine(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling nest() on a Query is deprecated. ' . 'Instead call `$query->all()->nest(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling insert() on a Query is deprecated. ' . 'Instead call `$query->all()->insert(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling toList() on a Query is deprecated. ' . 'Instead call `$query->all()->toList(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling compile() on a Query is deprecated. ' . 'Instead call `$query->all()->compile(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling lazy() on a Query is deprecated. ' . 'Instead call `$query->all()->lazy(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling buffered() on a Query is deprecated. ' . 'Instead call `$query->all()->buffered(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling listNested() on a Query is deprecated. ' . 'Instead call `$query->all()->listNested(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling stopWhen() on a Query is deprecated. ' . 'Instead call `$query->all()->stopWhen(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling unfold() on a Query is deprecated. ' . 'Instead call `$query->all()->unfold(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling through() on a Query is deprecated. ' . 'Instead call `$query->all()->through(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling zip() on a Query is deprecated. ' . 'Instead call `$query->all()->zip(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling zipWith() on a Query is deprecated. ' . 'Instead call `$query->all()->zipWith(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling chunk() on a Query is deprecated. ' . 'Instead call `$query->all()->chunk(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling chunkWithKeys() on a Query is deprecated. ' . 'Instead call `$query->all()->chunkWithKeys(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling isEmpty() on a Query is deprecated. ' . 'Instead call `$query->all()->isEmpty(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling unwrap() on a Query is deprecated. ' . 'Instead call `$query->all()->unwrap(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling transpose() on a Query is deprecated. ' . 'Instead call `$query->all()->transpose(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling count() on a Query is deprecated. ' . 'Instead call `$query->all()->count(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling countKeys() on a Query is deprecated. ' . 'Instead call `$query->all()->countKeys(...)` instead.');
    ...
    {
        deprecationWarning('4.3.0 - Calling cartesianProduct() on a Query is deprecated. ' . 'Instead call `$query->all()->cartesianProduct(...)` instead.');
