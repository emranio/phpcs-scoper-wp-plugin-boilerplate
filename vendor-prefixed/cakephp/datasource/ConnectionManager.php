...
use MyVendorPrefix\Cake\Core\StaticConfigTrait;
use MyVendorPrefix\Cake\Database\Connection;
use MyVendorPrefix\Cake\Database\Driver\Mysql;
use MyVendorPrefix\Cake\Database\Driver\Postgres;
use MyVendorPrefix\Cake\Database\Driver\Sqlite;
use MyVendorPrefix\Cake\Database\Driver\Sqlserver;
use MyVendorPrefix\Cake\Datasource\Exception\MissingDatasourceConfigException;
/**
...
class ConnectionManager
{
     ...
     */
    protected static $_dsnClassMap = ['mysql' => Mysql::class, 'postgres' => Postgres::class, 'sqlite' => Sqlite::class, 'sqlserver' => Sqlserver::class];
    /**
     ...
     * data is missing.
     */
    public static function get(string $name, bool $useAliases = \true)
    {
