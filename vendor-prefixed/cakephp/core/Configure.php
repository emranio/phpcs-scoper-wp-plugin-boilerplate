...
use MyVendorPrefix\Cake\Core\Configure\ConfigEngineInterface;
use MyVendorPrefix\Cake\Core\Configure\Engine\PhpConfig;
...
class Configure
{
     ...
     */
    protected static $_values = ['debug' => \false];
    /**
