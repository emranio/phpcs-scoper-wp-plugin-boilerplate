...
use MyVendorPrefix\Cake\Console\CommandCollection;
use MyVendorPrefix\Cake\Http\MiddlewareQueue;
use MyVendorPrefix\Cake\Routing\RouteBuilder;
use Closure;
...
class BasePlugin implements PluginInterface
{
     ...
     * @var bool
     */
    protected $bootstrapEnabled = \true;
    /**
     * Console middleware
     *
     * @var bool
     */
    protected $consoleEnabled = \true;
    /**
     * Enable middleware
     *
     * @var bool
     */
    protected $middlewareEnabled = \true;
    /**
     * Register container services
     *
     * @var bool
     */
    protected $servicesEnabled = \true;
    /**
     * Load routes or not
     *
     * @var bool
     */
    protected $routesEnabled = \true;
    /**
    ...
    protected function checkHook(string $hook): void
    {
        if (!in_array($hook, static::VALID_HOOKS, \true)) {
            throw new InvalidArgumentException("`{$hook}` is not a valid hook name. Must be one of " . implode(', ', static::VALID_HOOKS));
        }
    }
    /**
     * @inheritDoc
