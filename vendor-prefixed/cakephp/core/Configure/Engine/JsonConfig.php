 ...
 */
namespace MyVendorPrefix\Cake\Core\Configure\Engine;

use MyVendorPrefix\Cake\Core\Configure\ConfigEngineInterface;
use MyVendorPrefix\Cake\Core\Configure\FileConfigTrait;
...
class JsonConfig implements ConfigEngineInterface
{
    ...
    public function read(string $key): array
    {
        ...
        $values = json_decode(file_get_contents($file), \true);
