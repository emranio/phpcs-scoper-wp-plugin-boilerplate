 ...
 */
use function MyVendorPrefix\Cake\Core\deprecationWarning as cakeDeprecationWarning;
use function MyVendorPrefix\Cake\Core\env as cakeEnv;
use function MyVendorPrefix\Cake\Core\getTypeName as cakeGetTypeName;
use function MyVendorPrefix\Cake\Core\h as cakeH;
use function MyVendorPrefix\Cake\Core\namespaceSplit as cakeNamespaceSplit;
use function MyVendorPrefix\Cake\Core\pj as cakePj;
use function MyVendorPrefix\Cake\Core\pluginSplit as cakePluginSplit;
use function MyVendorPrefix\Cake\Core\pr as cakePr;
use function MyVendorPrefix\Cake\Core\triggerWarning as cakeTriggerWarning;
if (!\defined('DS')) {
    /**
...
if (!\function_exists('MyVendorPrefix\h')) {
    /**
     ...
     */
    function h($text, bool $double = \true, ?string $charset = null)
    {
        return cakeH($text, $double, $charset);
    }
}
if (!\function_exists('MyVendorPrefix\pluginSplit')) {
    /**
...
if (!\function_exists('MyVendorPrefix\namespaceSplit')) {
    /**
...
if (!\function_exists('MyVendorPrefix\pr')) {
    /**
...
if (!\function_exists('MyVendorPrefix\pj')) {
    /**
...
if (!\function_exists('MyVendorPrefix\triggerWarning')) {
    /**
...
if (!\function_exists('MyVendorPrefix\deprecationWarning')) {
    /**
...
if (!\function_exists('MyVendorPrefix\getTypeName')) {
    /**
