 ...
 */
namespace MyVendorPrefix\Cake\Core\TestSuite;

use MyVendorPrefix\Cake\Core\Configure;
use MyVendorPrefix\Cake\Core\ContainerInterface;
use MyVendorPrefix\Cake\Event\EventInterface;
use Closure;
use MyVendorPrefix\League\Container\Exception\NotFoundException;
use LogicException;
/**
...
// phpcs:disable
class_alias('MyVendorPrefix\Cake\Core\TestSuite\ContainerStubTrait', 'MyVendorPrefix\Cake\TestSuite\ContainerStubTrait');
// phpcs:enable
