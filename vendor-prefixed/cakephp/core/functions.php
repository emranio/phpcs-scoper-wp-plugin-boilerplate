...
namespace MyVendorPrefix\Cake\Core;

if (!function_exists('MyVendorPrefix\Cake\Core\h')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\pluginSplit')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\namespaceSplit')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\pr')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\pj')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\env')) {
    /**
...
if (!function_exists('MyVendorPrefix\Cake\Core\triggerWarning')) {
    /**
    ...
    function triggerWarning(string $message): void
    {
        ...
        if (isset($trace[1])) {
            ...
            $message = sprintf('%s - %s, line: %s', $message, $frame['file'], $frame['line']);
        }
        trigger_error($message, \E_USER_WARNING);
    }
}
if (!function_exists('MyVendorPrefix\Cake\Core\deprecationWarning')) {
    /**
    ...
    function deprecationWarning(string $message, int $stackFrame = 1): void
    {
        ...
        if (isset($trace[$stackFrame])) {
            ...
            $message = sprintf("%s\n%s, line: %s\n" . 'You can disable all deprecation warnings by setting `Error.errorLevel` to ' . '`E_ALL & ~E_USER_DEPRECATED`. Adding `%s` to `Error.ignoredDeprecationPaths` ' . 'in your `config/app.php` config will mute deprecations from that file only.', $message, $frame['file'], $frame['line'], $relative);
        }
        static $errors = [];
...
if (!function_exists('MyVendorPrefix\Cake\Core\getTypeName')) {
    /**
