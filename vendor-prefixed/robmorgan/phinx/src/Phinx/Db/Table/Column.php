 ...
 */
namespace MyVendorPrefix\Phinx\Db\Table;
...
class Column
{
    ...
    {
        return ['limit', 'default', 'null', 'identity', 'scale', 'after', 'update', 'comment', 'signed', 'timezone', 'properties', 'values', 'collation', 'encoding', 'srid', 'seed', 'increment'];
    }
    /**
    ...
    {
        return ['length' => 'limit', 'precision' => 'limit'];
    }
    /**
    ...
    public function setOptions($options)
    {
        ...
        foreach ($options as $option => $value) {
            ...
            if (!in_array($option, $validOptions, \true)) {
