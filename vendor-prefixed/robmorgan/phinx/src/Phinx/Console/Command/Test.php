...
class Test extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setDescription('Verify the configuration file')->setHelp(<<<EOT
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        array_map([$this, 'verifyMigrationDirectory'], Util::globAll($this->getConfig()->getMigrationPaths()));
        // Verify the seed path(s)
        array_map([$this, 'verifySeedDirectory'], Util::globAll($this->getConfig()->getSeedPaths()));
