 ...
 */
namespace MyVendorPrefix\Phinx\Util;
...
class Util
{
    ...
    public static function isUniqueMigrationClassName($className, $path)
    {
        ...
        return !in_array($className, $existingClassNames, \true);
    }
    /**
    ...
    {
        return (bool) preg_match(static::MIGRATION_FILE_NAME_PATTERN, $fileName) || (bool) preg_match(static::MIGRATION_FILE_NAME_NO_NAME_PATTERN, $fileName);
    }
    /**
