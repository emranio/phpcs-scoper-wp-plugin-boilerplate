...
namespace MyVendorPrefix\Brick\Math;

use MyVendorPrefix\Brick\Math\Exception\DivisionByZeroException;
use MyVendorPrefix\Brick\Math\Exception\IntegerOverflowException;
use MyVendorPrefix\Brick\Math\Exception\MathException;
use MyVendorPrefix\Brick\Math\Exception\NegativeNumberException;
use MyVendorPrefix\Brick\Math\Exception\NumberFormatException;
use MyVendorPrefix\Brick\Math\Internal\Calculator;
/**
