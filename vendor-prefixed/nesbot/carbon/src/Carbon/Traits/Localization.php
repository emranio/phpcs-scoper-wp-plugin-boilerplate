 ...
 */
namespace MyVendorPrefix\Carbon\Traits;

use MyVendorPrefix\Carbon\CarbonInterface;
use MyVendorPrefix\Carbon\Exceptions\InvalidTypeException;
use MyVendorPrefix\Carbon\Exceptions\NotLocaleAwareException;
use MyVendorPrefix\Carbon\Language;
use MyVendorPrefix\Carbon\Translator;
use MyVendorPrefix\Carbon\TranslatorStrongTypeInterface;
use Closure;
use MyVendorPrefix\Symfony\Component\Translation\TranslatorBagInterface;
use MyVendorPrefix\Symfony\Component\Translation\TranslatorInterface;
use MyVendorPrefix\Symfony\Contracts\Translation\LocaleAwareInterface;
use MyVendorPrefix\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('MyVendorPrefix\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('MyVendorPrefix\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('MyVendorPrefix\Symfony\Contracts\Translation\TranslatorInterface', 'MyVendorPrefix\Symfony\Component\Translation\TranslatorInterface');
}
