 ...
 */
use MyVendorPrefix\Symfony\Polyfill\Intl\Normalizer as p;
if (!\function_exists('normalizer_is_normalized') && !\function_exists('MyVendorPrefix\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('MyVendorPrefix\normalizer_normalize')) {
