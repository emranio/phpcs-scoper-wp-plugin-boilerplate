 ...
 */
namespace MyVendorPrefix\Symfony\Component\Console\Logger;

use MyVendorPrefix\Psr\Log\AbstractLogger;
use MyVendorPrefix\Psr\Log\InvalidArgumentException;
use MyVendorPrefix\Psr\Log\LogLevel;
