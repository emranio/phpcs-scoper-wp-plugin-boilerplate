 ...
 */
namespace MyVendorPrefix\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'MyVendorPrefix\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'MyVendorPrefix\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'MyVendorPrefix\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'MyVendorPrefix\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'MyVendorPrefix\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'MyVendorPrefix\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
