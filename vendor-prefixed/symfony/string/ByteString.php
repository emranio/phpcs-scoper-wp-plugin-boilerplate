 ...
 */
namespace MyVendorPrefix\Symfony\Component\String;

use Random\Randomizer;
use MyVendorPrefix\Symfony\Component\String\Exception\ExceptionInterface;
use MyVendorPrefix\Symfony\Component\String\Exception\InvalidArgumentException;
use MyVendorPrefix\Symfony\Component\String\Exception\RuntimeException;
/**
    ...
    public function toCodePointString(?string $fromEncoding = null): CodePointString
    {
        ...
        try {
            try {
                ...
                if (!\function_exists('iconv') && !\function_exists('MyVendorPrefix\iconv')) {
                    throw $e;
                }
