...
namespace MyVendorPrefix\Doctrine\Inflector\Rules\Spanish;

use MyVendorPrefix\Doctrine\Inflector\Rules\Pattern;
use MyVendorPrefix\Doctrine\Inflector\Rules\Substitution;
use MyVendorPrefix\Doctrine\Inflector\Rules\Transformation;
use MyVendorPrefix\Doctrine\Inflector\Rules\Word;
class Inflectible
{
    ...
    {
        yield new Transformation(new Pattern('/ú([sn])$/i'), 'MyVendorPrefix\u\1es');
        yield new Transformation(new Pattern('/ó([sn])$/i'), 'MyVendorPrefix\o\1es');
        yield new Transformation(new Pattern('/í([sn])$/i'), 'MyVendorPrefix\i\1es');
        yield new Transformation(new Pattern('/é([sn])$/i'), 'MyVendorPrefix\e\1es');
        yield new Transformation(new Pattern('/á([sn])$/i'), 'MyVendorPrefix\a\1es');
