...
use MyVendorPrefix\Dbout\WpOrm\Builders\UserBuilder;
use MyVendorPrefix\Dbout\WpOrm\Concerns\HasMeta;
use MyVendorPrefix\Dbout\WpOrm\MetaMappingConfig;
use MyVendorPrefix\Dbout\WpOrm\Models\Meta\UserMeta;
...
class User extends AbstractModel implements WithMetaModelInterface
{
     ...
     * @inheritDoc
     */
    protected $casts = [self::STATUS => 'integer', self::REGISTERED => 'datetime'];
    /**
     * @inheritDoc
     */
