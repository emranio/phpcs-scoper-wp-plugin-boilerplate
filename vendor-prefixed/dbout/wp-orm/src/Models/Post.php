...
use MyVendorPrefix\Dbout\WpOrm\Concerns\HasMeta;
use MyVendorPrefix\Dbout\WpOrm\MetaMappingConfig;
use MyVendorPrefix\Dbout\WpOrm\Models\Meta\PostMeta;
...
class Post extends AbstractModel implements WithMetaModelInterface
{
     ...
     * @inheritDoc
     */
    protected $casts = [self::MENU_ORDER => 'integer', self::COMMENT_COUNT => 'integer', self::DATE => 'datetime', self::MODIFIED => 'datetime', self::DATE_GMT => 'datetime', self::MODIFIED_GMT => 'datetime'];
    /**
     * @var string
     */
