 ...
 */
namespace MyVendorPrefix\Dbout\WpOrm\Concerns;

use MyVendorPrefix\Dbout\WpOrm\MetaMappingConfig;
use MyVendorPrefix\Dbout\WpOrm\Models\Meta\AbstractMeta;
...
trait HasMeta
{
    ...
    {
        // @phpstan-ignore-next-line
        return $this->metas()->where($this->getMetaConfigMapping()->columnKey, $metaKey)->exists();
    }
    /**
     * @param string $metaKey
     * @param mixed $value
    ...
    public function setMeta(string $metaKey, mixed $value): ?AbstractMeta
    {
        ...
        $instance = $this->metas()->firstOrNew([$this->getMetaConfigMapping()->columnKey => $metaKey]);
        $instance->fill([$this->getMetaConfigMapping()->columnValue => $value])->save();
        return $instance;
    }
    /**
     * @param string $metaKey
    ...
    public function deleteMeta(string $metaKey): bool
    {
        ...
        // @phpstan-ignore-next-line
        return $this->metas()->where($this->getMetaConfigMapping()->columnKey, $metaKey)->forceDelete();
    }
    /**
     * @return void
     */
